...
def libr():
    ...
    b1=Button(win, height=2,width=25,text=' Add Book ',bg='white',command=addbook)
    b2=Button(win, height=2,width=25,text=' Issue Book ',bg='white',command=issuebook)
    b3=Button(win, height=2,width=25,text=' Return Book ',bg='white',command=returnbook)
    b4=Button(win, height=2,width=25,text=' View Book ',bg='white',command=viewbook)
    b5=Button(win, height=2,width=25,text=' Issued Book ',bg='white',command=issuedbook)
    b6=Button(win, height=2,width=25,text=' Delete Book ',bg='white',command=deletebook)
    b7=Button(win, height=2,width=25,text=' LogOut ',bg='white',command=logout)
    b1.place(x=110,y=30)
    b2.place(x=110,y=80)
...
def addbook():
    ...
    b=Button(win, height=2,width=21,text=' ADD BOOK TO DB ',bg='red',command=addbooks)
    b1=Button(win, height=2,width=21,text=' CLOSE ',bg='red',command=closebooks)
    sub.place(x=70,y=50)
    tit.place(x=70,y=90)
...
def issuebook():
    ...
    win.geometry("400x400+480+180")
    win.resizable(False,False)
    name=Label(win,text='ISSUE ',font='times new roman 30 bold')
    branch=Label(win,text='BOOK',font='times new roman 30 bold')
    ...
    b=Button(win, height=2,width=21,text=' ISSUE BOOK ',bg='red',command=issuebooks)
    b1=Button(win, height=2,width=21,text=' CLOSE ',bg='red',command=closebooks)
...
def returnbook():
    ...
    win.geometry("400x400+480+180")
    win.resizable(False,False)
    ret=Label(win,text='RETURN ',font='times new roman 30 bold')
    book=Label(win,text='BOOK',font='times new roman 30 bold')
    no=Label(win,text='BOOK NO')
    ...
    b=Button(win, height=2,width=21,text=' RETURN BOOK ',bg='red',command=returnbooks)
    b1=Button(win, height=2,width=21,text=' CLOSE ',bg='red',command=closebooks)
    ret.place(x=55,y=30)
...
def deletebook():
    ...
    global e2,b2
    e2=Entry(win)
    b1=Button(win, height=2,width=17,text=' DELETE ',bg='red',command=deletebooks)
    b2=Button(win, height=2,width=17,text=' CLOSE ',bg='red',command=closebooks)
...
def adduser():
    ...
    global e4
    e4=Entry(win,width=25)
    b=Button(win, height=2,width=21,text=' ADD USER ',bg='red',command=addusers)
    b1=Button(win, height=2,width=21,text=' CLOSE ',bg='red',command=closeusers)
...
def home():
    try:
        ...
        #wel=Label(window,text='LIBRARY',font='times new roman 28 bold')
        #lib=Label(window,text='MANAGEMENT',font='times new roman 28 bold')
